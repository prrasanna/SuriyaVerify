  ...
  return (
    <div className="w-full animate-fadeIn">
      ...
      <section className="relative w-full overflow-hidden bg-[#0F172A] text-white">
        ...
        <div className="container mx-auto px-6 py-24 relative z-10 flex flex-col items-center text-center">
            ...
            <div className="mb-8 inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-slate-600 bg-slate-800/50 backdrop-blur-sm">
                <span className="text-xs font-semibold text-slate-300 uppercase tracking-wider">{t('home.hero.badge')}</span>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                >
                    {t('home.btn.start')} <ArrowRight size={20} />
                </button>
                <button 
      ...
      <section className="py-20 bg-white dark:bg-slate-900">
          <div className="container mx-auto px-6">
              <div className="text-center mb-16">
                  <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-3">{t('home.hero.badge').split(':')[0]} Core Capabilities</h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  ...
                  <div className="p-8 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 hover:shadow-xl transition-shadow group">
                      ...
                      <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{t('home.feat.1.title')}</h3>
                  ...
                  <div className="p-8 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 hover:shadow-xl transition-shadow group">
                      ...
                      <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{t('home.feat.2.title')}</h3>
                      <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                          {t('home.feat.2.desc')}
                      </p>
                  </div>
                  ...
                  <div className="p-8 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 hover:shadow-xl transition-shadow group">
                      ...
                      <h3 className="text-xl font-bold text-slate-900 dark:text-white mb-3">{t('home.feat.3.title')}</h3>
                      <p className="text-slate-600 dark:text-slate-400 leading-relaxed text-sm">
                          {t('home.feat.3.desc')}
                      </p>
                  </div>
      ...
      <section className="py-20 bg-[#FFFBEB] dark:bg-slate-950 border-t border-orange-100 dark:border-slate-800">
        <div className="container mx-auto px-6">
            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-12">{t('home.scheme.title')}</h2>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-sm border border-slate-200 dark:border-slate-800 relative overflow-hidden">
                    ...
                    <span className="text-xs font-bold text-orange-600 dark:text-orange-400 uppercase tracking-widest mb-2 block">{t('home.scheme.challenge')}</span>
                    <h3 className="text-2xl font-serif italic text-slate-800 dark:text-slate-200 mb-4">{t('home.scheme.question')}</h3>
                    <p className="text-slate-600 dark:text-slate-400">
                        {t('home.scheme.answer')}
                    </p>
                </div>

                {/* Bullets */}
                <div className="space-y-4">
                    <SchemeItem text={t('home.scheme.target')} />
                    <SchemeItem text={t('home.scheme.launched')} />
                    <SchemeItem text={t('home.scheme.savings')} />
                    <SchemeItem text={t('home.scheme.goal')} />
                </div>
            </div>
        </div>
      </section>
